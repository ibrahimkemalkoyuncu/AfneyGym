...
{
    /// <inheritdoc />
    public partial class AddPaymentsInvoicesAndAutoRenew : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HtmlReceipt = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Subscriptions_AutoRenew_EndDate",
                table: "Subscriptions",
                columns: new[] { "AutoRenew", "EndDate" });
